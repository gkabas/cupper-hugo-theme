...
<button onclick="abs1()">Abstract</button> <button onclick="fig1()">Main Results</button> <a href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4075737" target="_blank" rel="noopener noreferrer" class="ai ai-ssrn"></a><a href="https://gkabas.netlify.app/files/BenincasaKabasOngena.pdf" target="_blank" rel="noopener noreferrer" class="fa-regular fa-file-pdf" style="margin-left:0.2em; width: 28px; color: #3B5998"></a> <form action="https://gkabas.netlify.app/files/BenincasaKabasOngena.pdf" method="get" target="_blank"><button type="submit">SSRN</button> </form>  <form action="https://gkabas.netlify.app/files/BenincasaKabasOngena.pdf" method="get" target="_blank"><buttonSSRN type="submit">SSRN</buttonSSRN> </form> 
