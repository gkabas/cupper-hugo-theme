...
<button id="main-results-fig3" onclick="abs3()">Abstract</button> <button id="main-results-res3" onclick="fig3()">Main Results</button> <buttonSSRN onclick="ssrn3()">SSRN</buttonSSRN> <buttonPDF onclick="pdf3()">PDF</buttonPDF> <buttonPub onclick="published3()">Published Version</buttonPub>   
...
<button id="main-results-fig4" onclick="abs4()">Abstract</button> <button id="main-results-res4" onclick="fig4()">Main Results</button> <buttonSSRN onclick="ssrn4()">SSRN</buttonSSRN> <buttonPDF onclick="pdf4()">PDF</buttonPDF> <buttonPub onclick="published4()">Published Version</buttonPub>  
